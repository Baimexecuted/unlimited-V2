...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa follow Tiktok lugowo.hy")
time.sleep(3)
os.system("xdg-open https://www.tiktok.com/@lugowo.hy?_t=8bffjEc53Nh&_r=1")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Thx yang udah follow, semoga work")
time.sleep(3)
os.system("clear")
autoketik(f"""
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Baim executed
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : Baimexecuted
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : gk punya
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @gakpunya
